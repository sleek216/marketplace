...
import { prefetchStorePopoverData } from "./NavStorePopover";
import { useNavDropdown } from "./useNavDropdown";

const NavStore = ({ isOpen, anchorEl, onOpen, onClose }) => {
  ...
  const handlePrefetch = () => {
    prefetchStorePopoverData(modules ?? []);
  };
