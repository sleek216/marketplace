...
const ImageTitleSection: React.FC<ImageTitleSectionProps> = ({
    ...
    // API may send status as string ("1"); treat like other landing flags (Number coercion).
    if (
        highlight_section != null &&
        highlight_section.highlight_section_status != null &&
        Number(highlight_section.highlight_section_status) !== 1
    ) {
        return null;
    }
