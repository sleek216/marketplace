...
import { LEGACY_BRAND_PATTERN } from "utils/brandFilter";
          ...
          <Grid item xs={12} md={8.6} sx={{ textAlign: { xs: "center", md: "left" } }}>
            <Typography variant="h4" fontSize={{ xs: "18px", md: "30px" }} sx={{ fontWeight: "600" }}>
              <DollarSignHighlighter
                text={
                  seller_app_download_section?.download_seller_app_title
                    ?.replace(LEGACY_BRAND_PATTERN, "Gift Marketplace Seller")
                }
                theme={theme}
              />
            </Typography>
            ...
            <Link href={{ pathname: "/store-registration", query: { active: "active" } }} prefetch={false}>
              <Button variant="contained" sx={{ borderRadius: "4px", padding: "7px 16px",marginBottom:{xs:"1rem",sm:"0px"} }}>
