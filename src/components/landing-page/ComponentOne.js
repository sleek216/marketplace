import { ArrowRight as ArrowRightAltIcon } from "lucide-react";
import {
  alpha,
  Button,
  Grid,
...
export const CustomButton = styled(Button)(({ theme }) => ({
    ...
    height: "45px",
    borderRadius: "30px",
    boxShadow: `0px 4px 60px ${alpha(theme.palette.primary.main, 0.2)}`,
      ...
      <CustomContainer>
        <CustomBoxFullWidth
          sx={{
            ...
            p: { xs: "16px", md: "30px" },
            borderRadius: "10px",
            background: theme => theme.palette.gradients?.card || theme.palette.background.paper,
