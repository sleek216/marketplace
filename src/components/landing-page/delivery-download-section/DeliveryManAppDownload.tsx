...
import { CheckCircle2 as CheckCircle, ArrowRight, Smartphone as Android, Smartphone as Apple } from "lucide-react";
...
const DeliveryManAppDownload: React.FC<DeliveryManAppDownloadProps> = ({
  ...
  const titleText = sanitizeBrand(deliveryManApp?.download_dm_app_title);
  const subtitleHtml = sanitizeBrand(deliveryManApp?.download_dm_app_sub_title);
            ...
            >
              ...
              >
                {deliveryManApp?.download_dm_app_content_button_title ||
                  "Start Selling"}
                <ArrowForwardIcon size={20} style={{ marginLeft: "4px" }} />
              </Button>
            </Link>
          </Grid>
        </Grid>
