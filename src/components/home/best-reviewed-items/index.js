...
const BestReviewedItems = (props) => {
  ...
  const bestReviewedSliderSettings = {
    ...
    infinite: false,
    speed: 500,
    slidesToShow: info?.best_reviewed_section_banner && isLargeScreen ? 4 : 5,
    slidesToScroll: 2,
    cssEase: "linear",
    ...
    responsive: [
      ...
      },
      {
        breakpoint: 1150,
        settings: {
          slidesToShow: info?.best_reviewed_section_banner && isLargeScreen ? 2.6 : 2.1,
          slidesToScroll: 1,
        },
      },
      {
  ...
  const foodBestReviewedSliderSettings = {
    ...
    slidesPerRow: 1,
    rows: 2,
    slidesToShow: info?.best_reviewed_section_banner && isLargeScreen ? 2.1 : 2.7,
    slidesToScroll: 1,
    cssEase: "linear",
    ...createEnhancedArrows(isSliderHovered, { 
      displayNoneOnMobile: true,
            ...
            <>
              ...
              >
                ...
                <CustomBoxFullWidth>
                  ...
                  >
                    {info?.best_reviewed_section_banner && isLargeScreen && (
                    ...
                    <Grid
                      ...
                      xs={12}
                      sm={12}
                      lg={info?.best_reviewed_section_banner && isLargeScreen ? 9.5 : 12}
                    >
                      <SliderCustom 
                        nopadding="false" 
                        paddingBottom="1rem"
                      ...
                      >
                        <Stack>
                          <Slider {...bestReviewedSliderSettings}>
