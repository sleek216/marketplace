import { ArrowRight as ArrowForwardSharpIcon, HeartOff as FavoriteBorderOutlinedIcon, Star as StarIcon } from "lucide-react";
import {
  alpha,
  IconButton, Skeleton,
  Tooltip,
        ...
        {item?.add_type === "store_promotion" ? (
            ...
            <Stack width={0} flexGrow={1}>
              ...
              >
                ...
                {!isWishlisted ? (
                  ...
                  >
                    <FavoriteBorderOutlinedIcon color={theme.palette.primary.main} />
                  </IconButton>
                ) : (
                  <IconButton
          ...
          <>
            ...
            >
              ...
              >
                <ArrowForwardSharpIcon color={theme.palette.primary.main} />
              </IconButton>
            </Stack>
          </>
        )}
