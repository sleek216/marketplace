...
const DownloadSection = ({ landingPageData }) => {
	...
	// Temporarily hidden from main preview
	return null;
						...
						<Box>
							<Box>
								<H2
									...
									text={sanitizeBrand(landingPageData?.module_home_page_data_title)}
									component="h2"
								/>
								<Typography
									textAlign={{xs: "center", sm: "start"}}
									...
									color="textSecondary"
								>
									{sanitizeBrand(landingPageData?.module_home_page_data_sub_title)}
								</Typography>
					...
					>
						<Box>
							<Box>
								<H2
									textAlign={{xs: "center", sm: "start"}}
									text={sanitizeBrand(landingPageData?.module_vendor_registration_data_title)}
									component="h2"
								/>
								<Typography
									textAlign={{xs: "center", sm: "start"}}
								...
								>
									{
										sanitizeBrand(landingPageData?.module_vendor_registration_data_sub_title)
									}
								</Typography>
