...
import PlaceOrderSuccessSummary from "../checkout/PlaceOrderSuccessSummary";
import {
...
const OrderDetailsModal = ({ orderDetailsModalOpen }) => {
  ...
  const placeOrderData =
    orderInformation?.order_id || orderInformation?.is_multi_store
      ? orderInformation
      : getPlaceOrderSuccess();
  const isMulti = isMultiStorePlaceOrderResponse(placeOrderData);
  const primaryOrderId =
    placeOrderData?.order_id || guestUserOrderId || order_id || attributeId;
      ...
      {(flag && flag === "fail") || flag === "cancel" ? (
        ...
        >
          ...
          <Typography fontWeight="400" textAlign="center" maxWidth="380px">
            {isMulti
              ? t(
                  "We will begin processing your orders shortly. Please keep these Order IDs handy to track your orders."
                )
              : (
                <>
          ...
          {isMulti ? (
            <PlaceOrderSuccessSummary
              ...
              orderIdFallback={primaryOrderId}
            />
          ) : (
            <>
              <Typography fontWeight="400" textAlign="center" maxWidth="380px">
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    navigator.clipboard.writeText(String(primaryOrderId || ""));
