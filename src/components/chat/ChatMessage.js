	...
	const nameHandler = () => {
		...
		if (conversation.sender_type === "customer") {
			if (authorType === userType) {
				return getParticipantDisplayName(conversation.sender, {
					participantType: "customer",
				});
			}

			if (receiverType === "admin") {
				return configData?.business_name ?? "Admin";
			}

			return getParticipantDisplayName(conversation.receiver, {
				participantType: conversation.receiver_type,
		...
		return getParticipantDisplayName(conversation.sender, {
			participantType: conversation.sender_type,
		});
	};
