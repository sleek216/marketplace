    ...
    <CustomContainer sx={{ mb: { xs: 3, md: 4 } }}>
      <Box
        sx={{
          ...
          boxShadow: `0 10px 30px ${alpha(theme.palette.neutral[900], 0.06)}`,
          backgroundColor: "#ffffff",
        }}
      >
        <Grid container alignItems="stretch" sx={{ minHeight: { md: "220px" } }}>
          ...
          <Grid
            ...
            sx={{
              ...
              color: "#ffffff",
              p: { xs: "28px 20px", sm: "30px 24px", md: "32px 40px" },
              pr: { md: "75px", lg: "95px" },
              display: "flex",
          ...
          >
            ...
            <Box
              sx={{
                width: { xs: "110px", sm: "145px", md: "165px" },
                height: "auto",
                flexShrink: 0,
