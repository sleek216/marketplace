...
const gradients = {
	primary: "linear-gradient(135deg, #152e6e 0%, #3d5a9e 50%, #4a6bb0 100%)",
	primaryLight: "linear-gradient(135deg, #3d5a9e 0%, #4a6bb0 100%)",
	primaryDark: "linear-gradient(135deg, #0a1526 0%, #0f1f4d 50%, #152e6e 100%)",
	card: "linear-gradient(135deg, #1F2937 0%, #2D3748 100%)",
	button: "linear-gradient(135deg, #152e6e 0%, #3d5a9e 100%)",
	hover: "linear-gradient(135deg, #3d5a9e 0%, #4a6bb0 100%)",
	background: "linear-gradient(180deg, #1F2937 0%, #152e6e 100%)",
	heroBackground: "linear-gradient(180deg, rgba(31, 41, 55, 0.98) 0%, rgba(21, 46, 110, 0.4) 100%)",
	modulePanel: "radial-gradient(50% 50% at 50% 50%, rgba(21, 46, 110, 0) 0%, rgba(21, 46, 110, 0.3) 100%)",
	modulePanelHover: "radial-gradient(50% 50% at 50% 50%, rgba(21, 46, 110, 0) 0%, rgba(21, 46, 110, 0.45) 100%)",
	text: "linear-gradient(135deg, #4a6bb0 0%, #5c7fc4 100%)",
};

// SVG Colors for dark theme
const svg = {
	fill: {
		primary: "#4a6bb0",
		secondary: "#5c7fc4",
