export const english = {
  ...
  "Gift Marketplace is a multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system.": "Gift Marketplace brings your daily needs into one app—order food, groceries, pharmacy items, and more from trusted sellers near you. Download the app to shop faster, track deliveries, and enjoy a smoother checkout every time.",
  ...
  "Add Fund to Wallet minimum and enjoy percent bonus":
    "Add Fund to Wallet minimum {{min}} and enjoy {{percent}} % bonus",
  "Add Fund to Wallet minimum and enjoy amount bonus":
    "Add Fund to Wallet minimum {{min}} and enjoy {{amount}} bonus",
  "Add Image": "Add Image",
  ...
  "Register another store": "Register another store",
  "This creates a separate seller account and store ID. Your customer login stays the same. For another store, use a unique seller email and phone.": "This creates a separate seller account and store ID. Your customer login stays the same. For another store, use a unique seller email and phone.",
  "This seller email is already used. Use a different email to register another store.": "This seller email is already used. Use a different email to register another store.",
  "This seller phone is already used. Use a different phone number to register another store.": "This seller phone is already used. Use a different phone number to register another store.",
  ...
  "Seller Cover": "Business Cover",
  "Business Information": "Business Information",
  "Business Logo": "Business Logo",
  "Seller Logo": "Business Logo",
  ...
  "Choose Payment Method": "Choose Payment Method",
  "Choose home, office, or other for this address.": "Choose home, office, or other for this address.",
  ...
  "Complete Multipurpose": "All-in-one Marketplace",
  ...
  "Limited-time deals across the marketplace":
    "Limited-time deals across the marketplace",
  "deals": "deals",
  "Select location first to see flash deals":
    "Select location first to see flash deals",
  "Could not load flash deals. Please try again.":
    "Could not load flash deals. Please try again.",
  "No flash deals available right now": "No flash deals available right now",
  "Retry": "Retry",
  "Floor": "Floor",
  "Floor no.": "Floor no.",
  "Floor:": "Floor:",
  ...
  "Map View": "Map View",
  "Map pin hint": "Drag or zoom the map to set your delivery location.",
  "Massage to ": "Message to ",
  ...
  "Messages": "Messages",
  "Chat with support and vendors": "Chat with support and vendors",
  "No conversation selected": "No conversation selected",
  "Choose a chat from the list to view messages and reply.": "Choose a chat from the list to view messages and reply.",
  "Min": "Min",
  ...
  "No,Cancel": "No,Cancel",
  "No payment is required for this plan.": "No payment is required for this plan.",
  ...
  "Or Custom Massage": "Or Custom Message",
  "Or Custom Message": "Or Custom Message",
  "Order": "Order",
  ...
  "Recently viewed subtitle ecommerce": "Get back to products you viewed",
  "Recently viewed subtitle food": "Get back to food you viewed",
  "Recently viewed subtitle grocery": "Get back to items you viewed",
  "Recently viewed subtitle pharmacy": "Get back to items you viewed",
  "Recently viewed subtitle landing": "Pick up where you left off across the marketplace",
  "View All": "View All",
  "View all recently viewed items": "View all recently viewed items",
  "No recently viewed items found": "No recently viewed items found",
  "Free Shipping": "Free Shipping",
  "Popular Products": "Popular Products",
  "Popular products subtitle landing": "Discover top products from every module",
  "products across the marketplace": "products across the marketplace",
  "Browse products from every module in your zone": "Browse products from every module in your zone",
  "Could not load products. Please try again.": "Could not load products. Please try again.",
  "No products found in your zone yet.": "No products found in your zone yet.",
  "Load More": "Load More",
  ...
  "Register as seller and open shop in Gift Marketplace to start your business": "Register as seller and open shop in Gift Marketplace to start your business",
  ...
  "Multi-store order": "Multi-store order",
  "Group ID": "Group ID",
  "Stores": "Stores",
  ...
  "They create a account on Gift Marketplace using your code and place their first order": "They create a account on Gift Marketplace using your code and place their first order",
  "This": "This",
  ...
  "Track your order": "Track your order",
  "tracking_completed_pickup": "Ready — pickup complete",
  "tracking_delivered": "Delivered",
  "tracking_on_way_ecommerce": "Your package is on the way",
  "tracking_on_way_food": "Your food is on the way",
  "tracking_on_way_grocery": "Your groceries are on the way",
  "tracking_on_way_pharmacy": "Your order is on the way",
  "tracking_preparing_ecommerce": "Preparing your package",
  "tracking_preparing_food": "Preparing your food",
  "tracking_preparing_grocery": "Preparing your groceries",
  "tracking_preparing_pharmacy": "Preparing your medicines",
  "tracking_ready_pickup": "Ready for pickup",
  "tracking_sl_accepted": "Accepted by delivery",
  "tracking_sl_canceled": "Canceled",
  "tracking_sl_collected": "Collected",
  "tracking_sl_confirmed": "Confirmed",
  "tracking_sl_delivered": "Delivered",
  "tracking_sl_failed": "Failed",
  "tracking_sl_handover": "Handover",
  "tracking_sl_handover_default": "Handover",
  "tracking_sl_handover_food": "Handover",
  "tracking_sl_handover_takeaway": "Handover",
  "tracking_sl_order_preparing": "Order Preparing",
  "tracking_sl_out_for_delivery": "Out for delivery",
  "tracking_sl_pending": "Order Placed",
  "tracking_sl_picked_up_ecommerce": "Out for delivery",
  "tracking_sl_picked_up_food": "Out for delivery",
  "tracking_sl_picked_up_grocery": "Out for delivery",
  "tracking_sl_picked_up_pharmacy": "Out for delivery",
  "tracking_sl_picked_up_takeaway": "Collected",
  "tracking_sl_processing_ecommerce": "Order Preparing",
  "tracking_sl_processing_food": "Order Preparing",
  "tracking_sl_processing_grocery": "Order Preparing",
  "tracking_sl_processing_pharmacy": "Order Preparing",
  "tracking_sl_refund_request_canceled": "Refund request rejected",
  "tracking_sl_refund_requested": "Refund requested",
  "tracking_sl_refunded": "Refund credited",
  "tracking_sl_refund_resolved": "Case closed — payment sent",
  "tracking_sl_return_approved": "Return accepted",
  "tracking_sl_return_pickup_assigned": "Pickup assigned",
  "tracking_sl_return_picked_up": "Product collected",
  "tracking_sl_return_out_for_platform": "On the way to platform",
  "tracking_sl_return_awaiting_investigation": "Under investigation",
  "tracking_sl_return_out_for_vendor": "Returning to vendor",
  "tracking_sl_return_out_for_customer": "Returning to you",
  "tracking_sl_return_received_by_vendor": "Received by vendor",
  "order_status_refund_requested": "Request submitted — under review",
  "order_status_return_approved": "Return accepted — pickup will be scheduled",
  "order_status_return_pickup_assigned": "Return accepted — pickup will be scheduled",
  "order_status_return_picked_up": "Product collected — on the way to platform",
  "order_status_return_out_for_platform": "Product collected — on the way to platform",
  "order_status_return_awaiting_investigation": "Under investigation",
  "order_status_return_out_for_vendor": "Product returning to vendor",
  "order_status_return_out_for_customer": "Product returning to you",
  "order_status_return_received_by_vendor": "Vendor confirmed receipt",
  "order_status_refunded": "Refund credited to your wallet",
  "order_status_refund_resolved": "Payment sent — case closed",
  "order_status_refund_request_canceled": "Refund request rejected",
  "tracking_sl_returned": "Returned",
  "tracking_step_order_placed": "Order placed",
  "tracking_timeline_not_applicable": "timeline may not reflect this status",
  ...
  "Welcome to Gift Marketplace!": "Welcome to Gift Marketplace!",
  ...
  "Your store details are saved on this device only. Confirm to submit your registration. After this step, your seller account will be created.": "Your store details are saved on this device only. Confirm to submit your registration. After this step, your seller account will be created.",
  ...
  "Your product URL has been copied": "Your product URL has been copied",
  ...
  "refund_request_canceled": "Refund request rejected",
  "refunded": "Refund credited",
  "refund_resolved": "Payment sent — case closed",
  "return_approved": "Return accepted",
  "return_pickup_assigned": "Pickup assigned",
  "return_picked_up": "Product collected",
  "return_out_for_platform": "On the way to platform",
  "return_awaiting_investigation": "Under investigation",
  "return_out_for_vendor": "Returning to vendor",
  "return_out_for_customer": "Returning to you",
  "return_received_by_vendor": "Received by vendor",
  "restaurant address required": "restaurant address required",
  "restaurant name required": "restaurant name required",
  "restaurants": "restaurants",
  "satisfied": "satisfied",
