...
export const customer_notifications_api = "/api/v1/customer/notifications";
export const customer_notifications_mark_as_read_api =
  "/api/v1/customer/notifications/mark-as-read";
export const customer_notifications_mark_all_as_read_api =
  "/api/v1/customer/notifications/mark-all-as-read";
...
export const vendor_check_contact_api = "api/v1/auth/vendor/check-contact";
...
export const recently_viewed_list_api = "/api/v1/customer/recently-viewed";
export const recently_viewed_track_api = "/api/v1/customer/recently-viewed/track";
export const recently_viewed_merge_api = "/api/v1/customer/recently-viewed/merge";
export const recently_viewed_clear_api = "/api/v1/customer/recently-viewed/clear";
/** Cross-module catalog ? zoneId header only (no moduleId). */
export const marketplace_items_api = "/api/v1/marketplace/items";
/** Cross-module flash deals - zoneId header only (no moduleId). */
export const marketplace_flash_sales_items_api =
  "/api/v1/marketplace/flash-sales/items";
/** Cross-module recently viewed ? auth + zoneId (no moduleId). */
export const marketplace_recently_viewed_api =
